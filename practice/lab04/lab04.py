...
def closer_city(lat, lon, city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    tmp_city = make_city('TmpCity', lat, lon)
    distance_city1 = distance(tmp_city, city1)
    distance_city2 = distance(tmp_city, city2)
    return get_name(city2) if distance_city1 >= distance_city2 else get_name(city1)
